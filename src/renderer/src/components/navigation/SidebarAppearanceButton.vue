...
function updateAppearance(newAppearance: 'light' | 'dark' | 'system') {
    ...
    settingsStore.savePartialSettings({
        theme: { ...settingsStore.settings.theme, type: newAppearance }
    })
}
</script>
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent>
            <DropdownMenuItem
                ...
                :class="{ 'bg-primary text-white': currentAppearance === 'dark' }"
            >
                <Moon />
                Dark Mode
            </DropdownMenuItem>
            <DropdownMenuItem
                ...
                :class="{ 'bg-primary text-white': currentAppearance === 'light' }"
            >
                <Sun />
                Light Mode
            </DropdownMenuItem>
            <DropdownMenuItem
                ...
                :class="{ 'bg-primary text-white': currentAppearance === 'system' }"
            >
                <MonitorCog />
                System Default
            </DropdownMenuItem>
